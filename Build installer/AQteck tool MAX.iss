...
SetupIconFile=..\dist\AQteck tool MAX\Icons\AQico_silver.ico
Compression=lzma
...
[Files]
Source: "..\dist\AQteck tool MAX\AQteck tool MAX.exe"; DestDir: "{app}"; Flags: ignoreversion
Source: "..\dist\AQteck tool MAX\*"; DestDir: "{app}"; Flags: ignoreversion recursesubdirs createallsubdirs
