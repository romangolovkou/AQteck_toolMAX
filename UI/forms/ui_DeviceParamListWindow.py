...
class Ui_DeviceParamListWidget(object):
    def setupUi(self, DeviceParamListWidget):
        ...
        DeviceParamListWidget.resize(979, 325)
        sizePolicy = QSizePolicy(QSizePolicy.Fixed, QSizePolicy.Fixed)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(DeviceParamListWidget.sizePolicy().hasHeightForWidth())
        DeviceParamListWidget.setSizePolicy(sizePolicy)
